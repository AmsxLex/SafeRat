...
CXvidQuickDec::CXvidQuickDec(int version, unsigned int cpu_flags, int debug)
{
	m_version = version;
	m_bOpened = false;
...
CXvidQuickDec::~CXvidQuickDec()
{

}

bool CXvidQuickDec::Open(int width, int height, int cbit)
{
...
int CXvidQuickDec::Decode(void* input, int inlen, void* output)
{
